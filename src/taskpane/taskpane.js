...
const i18n = {
    fr: {
        ...
        optExp: "💡 Ajouter une bulle d'explication", optFmt: "🎨 Conserver la mise en forme multiples du texte (Expérimental)", optHint: "ℹ️ Cocher ces éléments accroît le temps de réponse (tokens).",
    ...
    en: {
        ...
        optExp: "💡 Add explanation bubble", optFmt: "🎨 Preserve multiple text formatting (Experimental)", optHint: "ℹ️ Checking these increases API requests and time (tokens).",
